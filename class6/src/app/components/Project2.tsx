  ...
  return (
    ...
    <div className='mx-auto pb-[4vmin] pt-[10vmin] bg-[#F3F3F3]'>
      <div className=' flex flex-col lg:flex-row items-center'>
       ...
       <h1 className='text-sm lg:text-left'>02 /PROJECT NAME</h1>
       <p className='text-sm lg:w-[33vmin] lg:mt-[3vmin]'>Subsurface weight, specular roughness, diffuse maps generated with the procedure and manual techniques.
       </p>
       <p className='text-[#606060] text-xs lg:w-[33vmin] lg:mt-[4vmin]'></p>
       <h2 className='text-sm mt-[15vmin]'><ins>See case study →</ins></h2>
        </div>
   {/* right column */}
